...
router.post('/', async (req, res) => {
    try {
        ...
        const duplicateCheck = await (0, contactService_1.checkDuplicate)(email, phone);
        ...
        const contact = await (0, contactService_1.addContact)({ name, email, phone });
...
router.get('/count', async (req, res) => {
    try {
        const count = await (0, contactService_1.getContactCount)();
        return res.json({
            success: true,
            count
        });
